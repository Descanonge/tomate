...
slices could be wrong and resulting array of size smaller than expected
[[file:data_loader/filegroup/filegroup_netcdf.py::def _load_slice_single_var(self, file: nc.Dataset,]]
** TODO Log reorder
